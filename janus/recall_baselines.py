...
# pluggable encoder (local bge-small by default; OpenAI if JANUS_EMBED=openai) — shared with the
# serving track's fixed reactive retriever, so it lives in janus.encoding, not here.
